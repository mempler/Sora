...
namespace Sora.Database
{
    ...
    public class SoraDbContextFactory
    {
        ...
        private ThreadLocal<SoraDbContext> _threadContexts;
        ...
        /// </summary>
        public SoraDbContext Get() => _threadContexts.Value;
        ...
        private void RecycleThreadContexts()
        {
            ...
            _threadContexts = new ThreadLocal<SoraDbContext>(CreateContext, true);
        }
