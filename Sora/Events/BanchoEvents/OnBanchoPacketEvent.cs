            ...
            switch (args.PacketId)
            {
                ...
                case PacketId.ClientUserStatsRequest:
                    await _evmgr.RunEvent(
                        ...
                        new BanchoUserStatsRequestArgs {pr = args.pr, userIds = args.Data.ReadData<UserStatsRequest>().Userids });
                    break;
                ...
                case PacketId.ClientFriendRemove:
                    await _evmgr.RunEvent(
                        ...
                        new BanchoFriendRemoveArgs {pr = args.pr, FriendId = args.Data.ReadData<FriendRemove>().FriendId});
                    break;
                ...
                case PacketId.ClientStartSpectating:
                    await _evmgr.RunEvent(
                        ...
                        new BanchoStartSpectatingArgs {pr = args.pr, SpectatorHostID = args.Data.ReadData<StartSpectating>().ToSpectateId});
                    break;
                ...
                case PacketId.ClientSpectateFrames:
                    await _evmgr.RunEvent(
                        ...
                        new BanchoBroadcastFramesArgs {pr = args.pr, frames = args.Data.ReadData<SpectatorFrames>().Frames});
                    break;
                ...
                case PacketId.ClientMatchChangeSlot:
                    await _evmgr.RunEvent(
                        ...
                        new BanchoMatchChangeSlotArgs {pr = args.pr, SlotId = args.Data.ReadData<MatchChangeSlot>().SlotId});
                    break;
                ...
                case PacketId.ClientMatchTransferHost:
                    await _evmgr.RunEvent(
                        ...
                        new BanchoMatchTransferHostArgs {pr = args.pr, SlotId = args.Data.ReadData<MatchTransferHost>().SlotId});
                    break;
                ...
                case PacketId.ClientMatchScoreUpdate:
                    await _evmgr.RunEvent(
                        ...
                        new BanchoMatchScoreUpdateArgs {pr = args.pr, Frame = args.Data.ReadData<MatchScoreUpdate>().Frame});
                    break;
